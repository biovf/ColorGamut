...
//            log2HdriPixelArray.r = Shaper.calculateLog2ToLinear(hdriPixelArray[i].r, midGreySDR.x,
//                minRadiometricExposure, maxRadiometricExposure);
//            log2HdriPixelArray.g = Shaper.calculateLog2ToLinear(hdriPixelArray[i].g, midGreySDR.x,
//                minRadiometricExposure, maxRadiometricExposure);
//            log2HdriPixelArray.b = Shaper.calculateLog2ToLinear(hdriPixelArray[i].b, midGreySDR.x,
//                minRadiometricExposure, maxRadiometricExposure);
