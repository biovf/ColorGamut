...
//    public CurveData(Vector2 midGreyPoint, 
//                    Vector2 origin, 
...
//    public GamutCurve2(CurveData curveData) 
//    {
//        this.originCoord = curveData.origin;
//        this.middleGrey = curveData.middleGrey;
//        this.minExposureValue = curveData.minExposureValue;
//        this.maxExposureValue = curveData.maxExposureValue;
//        this.maxRadiometricValue = curveData.maxRadiometricValue;
//        this.maxDisplayValue = curveData.maxDisplayValue;
//        this.slope = curveData.slope;
//    }
...
//    public Vector2[] createControlPoints()
//    {
//        minRadiometricValue = originCoord.x;
//        minDisplayValue = originCoord.y;
//        //minRadiometricValue = Shaper.calculateLinearToLog2(originCoord.x, midGreySDR.x, minRadiometricExposure, maxRadiometricExposure);
//        logMiddleGrey = new Vector2(
//            Shaper.calculateLinearToLog2(middleGrey.x, middleGrey.x, minExposureValue, maxExposureValue),
//            // Shaper.inverseSrgbEotfSimpleGamma(midGreySDR.y));
//            TransferFunction.ApplyInverseTransferFunction(middleGrey.y, TransferFunction.TransferFunctionType.sRGB));
//        float toeP2YCoord =
...
//            Shaper.calculateLinearToLog2(maxRadiometricValue, middleGrey.x, minExposureValue, maxExposureValue),
//            maxDisplayValue);
...
//                Shaper.calculateLog2ToLinear(logInputXCoord, logMiddleGrey.x, minExposureValue, maxExposureValue);
//            float linearXCoordIdx =
//                Shaper.calculateLog2ToLinear(xCoords[idx], logMiddleGrey.x, minExposureValue, maxExposureValue);
//            float linearXCoordIdx2 =
//                Shaper.calculateLog2ToLinear(xCoords[idx2], logMiddleGrey.x, minExposureValue, maxExposureValue);
...
//            Shaper.calculateLinearToLog2(inputXCoord, logMiddleGrey.x, minExposureValue, maxExposureValue);
