...
//            float[] lut3D = inputLutTex;//convertLut1DTo3D(inputLutTex,lutDim);
//            for (int i = 0; i < lut3D.Length; i+=3)
//            {
//                fileContents.Append(lut3D[i].ToString() + " " + lut3D[i+1].ToString() + " " + lut3D[i+2].ToString());
//                fileContents.AppendLine();
//            }
//        }
